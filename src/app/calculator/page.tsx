    ...
    return `
      ...
      ">
        ...
        <div style="text-align: center; margin-bottom: 32px; border-bottom: 2px solid ${brandingConfig.primaryColor}; padding-bottom: 24px;">
          ...
          ` : `
            <p style="font-size: 12px; color: #9ca3af; margin: 8px 0;">
              Professional analysis by BrokerageCalc
            </p>
          `}
        </div>
        ...
        <div style="border-top: 2px solid ${brandingConfig.primaryColor}; padding-top: 24px; text-align: center; font-size: 10px; color: #6b7280;">
          ...
          ` : ''}
          <p style="margin: 0;">
            Generated by BrokerageCalc on ${new Date().toLocaleDateString()} | 
            ...
            <Link href="/" className="flex items-center">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  >
                    {brandingConfig.agentName || 'BrokerageCalc'}
                  </h1>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <a
                              href="mailto:brokeragecalc@gmail.com?subject=Real Brokerage Questions&body=Hi, I used the BrokerageCalc calculator and I'm interested in learning more about Real Brokerage. My GCI is $${gciValue.toLocaleString()} and the potential savings shown were ${formatCurrency(potentialSavings)}."
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600">
                          BrokerageCalc may earn a commission if you join certain brokerages through our referral links. 
